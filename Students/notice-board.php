...
<body>
    ...
    <?php
    $nb_query = "SELECT * FROM cnb ORDER BY display_order ASC, id DESC";
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td data-order="<?php echo strtotime($notice['notice_date']); ?>">
                                                    <?php echo date("d-m-Y", strtotime($notice['notice_date'])); ?>
                                                </td>
                                                <td><?php echo htmlspecialchars($notice['title']); ?></td>
                                                <td class="text-center">
                                                    <?php if (!empty($notice['file'])): ?>
                                                        <a href="../Admin/<?php echo $notice['file']; ?>" target="_blank"
