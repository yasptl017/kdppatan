            ...
            <?php if ($results_result && $results_result->num_rows > 0): ?>
                <div class="table-card">
                    <div class="table-responsive">
                        <table id="resultsTable" class="table table-striped table-bordered table-hover align-middle w-100">
                            ...
                            <tbody>
                                <?php $i = 1; while ($result = $results_result->fetch_assoc()): ?>
                                    <tr>
                                        <td><?php echo $i++; ?></td>
                                        <td><?php echo htmlspecialchars($result['title']); ?></td>
                                        <td><?php echo (int)$result['display_order']; ?></td>
                                        <td>
