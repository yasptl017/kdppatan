...
$activity_query = "SELECT * FROM activities WHERE id = $activity_id AND department = '$DEPARTMENT_NAME'";
...
$page_title = $activity['title'] . " - " . $DEPARTMENT_NAME . " - K.D. Polytechnic"; 
?>
                    ...
                    <div class="activity-detail-card">
                        <div class="activity-detail-header">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <h2 class="activity-detail-title"><?php echo htmlspecialchars($activity['title']); ?></h2>
                                <span class="badge-category"><?php echo htmlspecialchars($activity['category']); ?></span>
                            </div>
                            
                            <div class="activity-meta-info">
                                <div class="meta-item">
                                    <i class="fas fa-calendar-alt"></i>
                                    <span><?php echo date("F d, Y", strtotime($activity['date'])); ?></span>
                                </div>
                                <?php if (!empty($activity['remark'])): ?>
                                <div class="meta-item">
                                    <i class="fas fa-user"></i>
                                    <span><?php echo htmlspecialchars($activity['remark']); ?></span>
                                </div>
                                <?php endif; ?>
                                <div class="meta-item">
                                    <i class="fas fa-building"></i>
                                    <span><?php echo htmlspecialchars($activity['department']); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="activity-detail-gallery">
                            ...
                            <div class="photo-gallery-grid">
                                ...
                                <div class="gallery-photo-item" onclick="openPhotoModal(<?php echo $index; ?>)">
                                    <img src="../Admin/<?php echo $photo; ?>" alt="Activity Photo <?php echo $index + 1; ?>">
