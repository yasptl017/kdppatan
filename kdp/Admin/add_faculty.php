...
<main class="main-content" id="mainContent">
    ...
    <div class="form-card">
        <form method="POST" enctype="multipart/form-data" id="facultyForm">
            ...
            <div class="mb-3">
                <textarea name="skills" id="skills" class="summernote"><?php echo $faculty['skills'] ?? ''; ?></textarea>
            </div>
            ...
            <div class="mb-3">
                <textarea name="course_taught" id="course_taught" class="summernote"><?php echo $faculty['course_taught'] ?? ''; ?></textarea>
            </div>
            ...
            <div class="mb-3">
                <textarea name="training" id="training" class="summernote"><?php echo $faculty['training'] ?? ''; ?></textarea>
            </div>
            ...
            <div class="mb-3">
                <textarea name="portfolio" id="portfolio" class="summernote"><?php echo $faculty['portfolio'] ?? ''; ?></textarea>
            </div>
            ...
            <div class="mb-3">
                <textarea name="research_projects" id="research_projects" class="summernote"><?php echo $faculty['research_projects'] ?? ''; ?></textarea>
            </div>
            ...
            <div class="mb-3">
                <textarea name="publications" id="publications" class="summernote"><?php echo $faculty['publications'] ?? ''; ?></textarea>
            </div>
            ...
            <div class="mb-3">
                <textarea name="academic_projects" id="academic_projects" class="summernote"><?php echo $faculty['academic_projects'] ?? ''; ?></textarea>
            </div>
            ...
            <div class="mb-3">
                <textarea name="patents" id="patents" class="summernote"><?php echo $faculty['patents'] ?? ''; ?></textarea>
            </div>
            ...
            <div class="mb-3">
                <textarea name="memberships" id="memberships" class="summernote"><?php echo $faculty['memberships'] ?? ''; ?></textarea>
            </div>
            ...
            <div class="mb-3">
                <textarea name="awards" id="awards" class="summernote"><?php echo $faculty['awards'] ?? ''; ?></textarea>
            </div>
