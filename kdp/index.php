...
<body>
    ...
    $first_active = true;
    ?>
    <section id="heroSlider" class="carousel slide hero-slider" data-bs-ride="carousel">
                ...
                <div class="carousel-item <?php echo $first_active ? 'active' : ''; ?>">
                    ...
                    <div class="carousel-caption d-block">
                        ...
                        <?php if (!empty($slide['button_text'])) { ?>
                            <button class="btn btn-primary"><?php echo $slide['button_text']; ?></button>
                        <?php } ?>
                    </div>
                </div>
            <?php } ?>
    ...
    <section class="py-5 bg-white">
        <div class="container">
            <div class="text-center mb-4">
                ...
                <p class="section-subtitle">Empowering Future Engineers & Technologists</p>
            </div>
