                ...
                <div class="col-6 col-lg-3">
                    <div class="quick-access-card">
                        <div class="quick-access-card-body">
                            ...
                            <p class="card-description">View &amp; manage your records</p>
                        </div>
                ...
                <div class="col-6 col-lg-3">
                    <div class="quick-access-card">
                        <div class="quick-access-card-body">
                            ...
                            <p class="card-description">Modify or delete entries</p>
                        </div>
                ...
                <div class="col-6 col-lg-3">
                    <div class="quick-access-card">
                        <div class="quick-access-card-body">
                            ...
                            <p class="card-description">Create lecture, lab, tutorial</p>
                        </div>
                ...
                <div class="col-6 col-lg-3">
                    <div class="quick-access-card">
                        <div class="quick-access-card-body">
                            ...
                            <p class="card-description">Generate Excel reports</p>
                        </div>
