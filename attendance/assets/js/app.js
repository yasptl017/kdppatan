...
/* ===== Responsive Sidepanel =====
   NOTE: All sidebar show/hide logic — including the backdrop tap — is owned
   by sidebar-toggle.js. app.js binds NO sidebar handlers, to avoid race
   conditions where two listeners toggle the same classes and the second one
   cancels out the first (the source of the intermittent "hamburger doesn't
   open sidebar on some devices" bug and the "backdrop tap swallowed after
   scrolling" bug). */
