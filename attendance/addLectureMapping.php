                    ...
                    <div class="app-card shadow-sm"><div class="app-card-body">
                        ...
                        <form method="POST" action="<?= htmlspecialchars($form_action) ?>">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-6 col-md-1"><label class="form-label">Term</label><select name="term" class="form-control" required><option value="">Term</option><?php foreach ($term_rows as $t): ?><option value="<?= htmlspecialchars($t) ?>" <?= ((string)$t === (string)$form_values['term']) ? 'selected' : '' ?>><?= htmlspecialchars($t) ?></option><?php endforeach; ?></select></div>
                                <div class="col-6 col-md-1"><label class="form-label">Semester</label><select name="sem" class="form-control" id="semSelect" required><option value="">Sem</option><?php foreach ($sem_rows as $s): ?><option value="<?= htmlspecialchars((string)$s['sem']) ?>" <?= ((string)$s['sem'] === (string)$form_values['sem']) ? 'selected' : '' ?>><?= htmlspecialchars((string)$s['sem']) ?></option><?php endforeach; ?></select></div>
                                <div class="col-12 col-md-4"><label class="form-label">Subject</label><select name="subject" class="form-control" id="subjectSelect" required><option value="">Select Semester first</option></select></div>
                                <div class="col-6 col-md-1"><label class="form-label">Class</label><select name="class" class="form-control" required><option value="">Class</option><?php foreach (['A','B','C','D'] as $c): ?><option value="<?= $c ?>" <?= ($c === (string)$form_values['class']) ? 'selected' : '' ?>><?= $c ?></option><?php endforeach; ?></select></div>
                            </div>

                            <div class="row g-2 mb-3">
                                <div class="col-6 col-md-2"><label class="form-label">Start Date</label><input type="date" name="start_date" class="form-control" value="<?= htmlspecialchars((string)$form_values['start_date']) ?>" required></div>
                                <div class="col-6 col-md-2"><label class="form-label">End Date</label><input type="date" name="end_date" class="form-control" value="<?= htmlspecialchars((string)$form_values['end_date']) ?>" required></div>
                            </div>
