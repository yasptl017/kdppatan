    ...
    <form method="POST" enctype="multipart/form-data" id="collegeForm">
        ...
        <div class="form-card">
            ...
            <textarea id="vision" name="vision" class="summernote"><?php
                echo htmlspecialchars($collegeData['vision'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
        </div>
        ...
        <div class="form-card">
            ...
            <textarea id="mission" name="mission" class="summernote"><?php
                echo htmlspecialchars($collegeData['mission'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
        </div>
        ...
        <div class="form-card">
            ...
            <div class="mb-3">
                ...
                <textarea id="principal_message" name="principal_message" class="summernote"><?php
                    echo htmlspecialchars($collegeData['principal_message'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
            </div>
        </div>
