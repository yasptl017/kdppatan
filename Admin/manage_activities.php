                ...
                <tr>
                    ...
                    <td class="text-center">
                        <button class="btn btn-warning btn-sm"
                                onclick='editActivity(<?php echo json_encode($row, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP); ?>)'
                                data-bs-toggle="modal"
                                data-bs-target="#activityModal"
                                title="Edit">
...
$('#activityModal').on('shown.bs.modal', function () {
    if (!$('#description').next('.note-editor').length) {
        initSummernote('#description', {height: 250, placeholder: "Enter activity description here..."});
    }
...
function editActivity(activity) {
    ...
    // Store description to be loaded when modal is shown and Summernote is ready
