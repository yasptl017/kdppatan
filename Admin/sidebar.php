    ...
    <ul class="sidebar-menu">
        ...
        <li class="menu-item">
            ...
            <ul class="submenu" id="usersMenu" aria-hidden="true">
                ...
                <li><a href="manage_dept_timetable.php">Time Tables</a></li>
                <li><a href="manage_dept_results.php">Results</a></li>
                <li><a href="manage_dept_material.php">Materials</a></li>
        ...
        <li class="menu-item">
            ...
            <ul class="submenu" id="productMenu" aria-hidden="true">
                <li><a href="manage_nb.php">Notice Board</a></li>
