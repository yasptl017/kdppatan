...
<body>
    ...
    <?php
    $nb_query = "SELECT * FROM nb WHERE department = '$DEPARTMENT_NAME' ORDER BY date DESC";
                ...
                <div class="col-12">
                    <div class="card shadow-sm border-0">
                        <div class="card-header text-white" style="background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%);">
                            <h5 class="mb-0"><i class="fas fa-bullhorn me-2"></i><?php echo $DEPARTMENT_NAME; ?> - Notices</h5>
                        </div>
